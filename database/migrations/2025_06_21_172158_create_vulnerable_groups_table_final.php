...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('vulnerable_groups', function (Blueprint $table) {
            ...
            $table->enum('disability_category', [
                'TERBARING', 
                'BERTONGKAT', 
                'BERKERUSI RODA', 
                'BOLEH BERJALAN', 
                'BUTA',
                'OKU (LAIN-LAIN KEUPAYAAN)',
                'WARGA EMAS (PENYAKIT 3 SERANGKAI)',
                'WARGA EMAS (PENYAKIT DARAH TINGGI)',
                'WARGA EMAS',
                'ISTERI TERLANTAR',
                'WARGA EMAS (TINGGAL BERDUA DENGAN ISTERI)',
                'WARGA EMAS (11 ORANG)',
                'WARGA EMAS (8 ORANG)',
                'WARGA EMAS (4 ORANG)',
                'WARGA EMAS (2 ORANG)',
